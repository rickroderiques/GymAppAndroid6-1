package com.example.rick.booking;
...
import com.example.rick.gymapp_android.respository.booking.Impl.MakeRepositoryImpl;
...
public class MakeBookingRepositoryTest extends AndroidTestCase {
    ...
    public void testCreateReadUpdateDelete() throws Exception {
        IMakeBooking repo = new MakeRepositoryImpl(this.getContext());
        // CREATE
