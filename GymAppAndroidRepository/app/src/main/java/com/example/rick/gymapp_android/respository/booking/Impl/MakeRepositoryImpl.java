package com.example.rick.gymapp_android.respository.booking.Impl;
...
import com.example.rick.gymapp_android.conf.databases.DBConstants;
import com.example.rick.gymapp_android.respository.booking.IMakeBooking;
import com.example.rick.gymapp_android.domain.booking.MakeBooking;

/**
 * Created by Rick on 24-Apr-16.
 */
public class MakeRepositoryImpl extends SQLiteOpenHelper implements IMakeBooking{
    ...
    public MakeRepositoryImpl(Context context)
    {
